...
/* 
    ../UserDetail/ServeComponent 의 다섯 개 컴포넌트들을 하나로 합친 코드이며, 
    해당 컴포넌트는 Button Component(수정하기, 추가하기 버튼)이 포함되지 않습니다.
    
    wip : UserDetail 컴포넌트들을 이용하려 했으나 실행이 되지 않아서 따로 코드를 복사해서 작성하였습니다.
*/
